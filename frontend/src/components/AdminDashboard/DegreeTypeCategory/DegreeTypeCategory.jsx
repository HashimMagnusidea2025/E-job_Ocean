...
export default function DegreeTypeCategoryPage() {
    ...
    const fetchCategories = async () => {
        try {
            const res = await axios.get("/degree-Type-Category");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (formData.id) {
                await axios.put(`/degree-Type-Category/${formData.id}`, {
                    name: formData.name,
                    status: formData.status
                });
                Swal.fire("Updated!", "Category updated successfully", "success");
            } else {
                await axios.post("/degree-Type-Category", {
                    name: formData.name,
                    status: formData.status
                });
    ...
    const handleToggleStatus = async (id, currentStatus) => {
        ...
        try {
            await axios.put(`/degree-Type-Category/${id}`, {
                name: category.name,
                status: newStatus
            });
        ...
        <Layout>
            <div className="p-6 w-full mx-auto">
                <div className="flex justify-between items-center mb-4">
                    <h1 className="text-xl font-bold">Degree Type Categories</h1>
                    <div className="flex gap-2">
                        <input
                            type="text"
                            placeholder="Search..."
